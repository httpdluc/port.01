...
export default class Floor {
    ...
    setCircles() {
        ...
        const material2 = new THREE.MeshStandardMaterial({ color: 0x001b00 });
        const material3 = new THREE.MeshStandardMaterial({ color: 0x00003f});

        this.circleFirst = new THREE.Mesh(geometry, material);
        this.circleSecond = new THREE.Mesh(geometry, material2);
        this.circleThird = new THREE.Mesh(geometry, material3);

        this.circleFirst.position.y = -0.26;
        this.circleFirst.position.x = 0.50;

        

        this.circleSecond.position.y = -0.25;
        this.circleSecond.position.x = 2;

        this.circleThird.position.y = -0.24;
